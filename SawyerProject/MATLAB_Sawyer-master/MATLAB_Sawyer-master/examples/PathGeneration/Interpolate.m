%This m-script is mainly interpolate the recorded data and plot the results
clc;
close all;

%% 
%Import packages
%Sawyer modeling packages
import LeonaRT.*;           
...
%%
%Create empty necessary array (4 data will received from Sawyer)
...
diffID_new = [0,diffID]; 
%%
%create new array, with lose framed, position and vel of 1 joint
...
%unknown reason that make calc_val extra 3 elements??
